...
namespace ReadMunicipalityData
{
    internal class Program
    {
        static async Task Main(string[] args)
        {
            ...
            try
            {
                var municipalities = ReadMunicipalities(filePath);
                municipalities.Sort((m1, m2) => m2.Population.CompareTo(m1.Population));
                await EnrichMunicipalitiesAsync(municipalities);
        ...
        private static List<Municipality> ReadMunicipalities(string filePath)
        {
        ...
        private static async Task EnrichMunicipalitiesAsync(List<Municipality> municipalities)
        {
        ...
        private static void WriteMunicipalitiesCsv(List<Municipality> municipalities, string outputPath)
        {
